...
class DataTransformation:
        ...
        try:
            ...
            cat_pipeline = Pipeline(
                steps=[
                    ...
                    ("scaler", StandardScaler(with_mean=False))  #  prevent sparse matrix error
                ]
            )
    ...
    def initiate_data_transformation(self, train_path, test_path):
        """
        Reads the training and test data, applies transformations,
        ...
        try:
            ...
            logging.info("Data transformation completed. Saving preprocessor object...")
